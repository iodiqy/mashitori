...
URL_VK = 'https://api.vk.com/method/wall.get?domain=tru_artist&count=10&filter=owner&access_token' \
         '=61be68a461be68a461be68a44461cf81fe661be61be68a43f02bf6a60dde50c255f8fd3&v=5.103 '
FILENAME_VK = 'last_known_id.txt'
BASE_POST_URL = 'https://vk.com/tru_artist?w=wall-72375839_'

CHANNEL_NAME = '@iodiqych'

# Если True, предполагается использование cron для за
# пуска скрипта
